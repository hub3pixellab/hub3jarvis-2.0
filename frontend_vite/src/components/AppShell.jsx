...
export default function AppShell({ children }) {
  ...
  const navItems = [
    ...
    { to: "/consensus", icon: Network, label: t.consensus || "Consensus", testid: "nav-consensus" },
    { to: "/brain", icon: Brain, label: lang==='pt'?'Cérebro':'Brain', testid: "nav-brain" },
    { to: "/smart-home", icon: HouseWifi, label: t.smartHome || "Smart Home", testid: "nav-smart-home" },
